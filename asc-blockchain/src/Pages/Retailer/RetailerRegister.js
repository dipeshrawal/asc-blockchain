...
function RetailerRegister() {
  ...
  const [userType, setUserType] = useState("retailer"); // Default to 'retailer'
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://127.0.0.1:8000/api/retailer/register/", {
        method: "POST",
        headers: {
    ...
    <div className="flex justify-center items-center h-screen bg-gradient-to-r from-green-200 via-green-300 to-blue-200 relative">
      ...
      <div className="bg-white p-10 rounded-lg shadow-2xl w-full max-w-4xl">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-6">
          ...
          {/* Store Type */}
          <div className="col-span-2 md:col-span-1">
            <label htmlFor="storeType" className="block text-sm font-medium mb-2">
              Store Type
            </label>
            <input
              type="text"
          ...
          {/* Inventory Capacity */}
          <div className="col-span-2 md:col-span-1">
            <label htmlFor="inventoryCapacity" className="block text-sm font-medium mb-2">
              Inventory Capacity
            </label>
            <input
              type="text"
